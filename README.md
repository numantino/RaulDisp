...
### Otros componentes
- **Bomba de agua:** Componente para controlar un rele que activara una bomba de agua. [ver](./doc/Rele.md)<br>
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="./doc/img/conexionPlacaNCU.png" style="max-width: 2000px; margin-right: 20px;">
</div>
